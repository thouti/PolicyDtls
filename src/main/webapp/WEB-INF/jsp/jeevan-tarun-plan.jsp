...
<body class="post-template-default single single-post postid-371 single-format-standard td-standard-pack lic-jeevan-tarun-plan global-block-template-4 td-medicine-pro td-animation-stack-type0 td-full-layout" itemscope="itemscope" itemtype="https://schema.org/WebPage">
...
<jsp:include page="../jsp/banner.jsp"></jsp:include>
    ...
    <article id="post-371" class="post-371 post type-post status-publish format-standard has-post-thumbnail category-child-plans" 0>
        <div class="td-post-header">

            <!-- category --><ul class="td-category"><li class="entry-category"><a  href="/sub/child-plans">Child Plans</a></li></ul>
            <header class="td-post-title">
                <h1 class="entry-title">LIC Jeevan Tarun Plan</h1>
...
<!-- /wp:button --></div></div>
<p>LIC Jeevan Tarun Policy is a participating money back plan most suitable for planning your child’s future requirements such as marriage, higher education etc. The plan needs to be taken in the name of the child only and the life insurance cover is provided to the child and not to the parent or proposer of the policy.</p>
...
<div class="schema-faq wp-block-yoast-faq-block"><div class="schema-faq-section" id="faq-question-1593929993539"><strong class="schema-faq-question">What is the date of launch of Jeevan Tarun?</strong> <p class="schema-faq-answer">This plan is launched on 24th April, 2015 by LIC.</p> </div> <div class="schema-faq-section" id="faq-question-1593930028029"><strong class="schema-faq-question">What is the table number as per LIC?</strong> <p class="schema-faq-answer">The table number is 834.</p> </div> <div class="schema-faq-section" id="faq-question-1593930065376"><strong class="schema-faq-question">What kind of plan is this?</strong> <p class="schema-faq-answer">It is Money Back plan for children.</p> </div> </div>
<div class="td-a-rec td-a-rec-id-content_bottom  tdi_9_18f td_block_template_4">
<style>
/* custom css */
.tdi_9_18f.td-a-rec{
					text-align: center;
				}.tdi_9_18f .td-element-style{
					z-index: -1;
				}.tdi_9_18f.td-a-rec-img{
				    text-align: left;
				}.tdi_9_18f.td-a-rec-img img{
                    margin: 0 auto 0 0;
                }@media (max-width: 767px) {
				    .tdi_9_18f.td-a-rec-img {
				        text-align: center;
...
<div class="wp-block-button"><a class="wp-block-button__link" href="tel:09949346104" style="border-radius:11px">9949346104</a></div>
    ...
    <div class="td_block_wrap td_block_related_posts tdi_10_d03 td_with_ajax_pagination td-pb-border-top td_block_template_4"  data-td-block-uid="tdi_10_d03" ><script>var block_tdi_10_d03 = new tdBlock();
block_tdi_10_d03.id = "tdi_10_d03";
block_tdi_10_d03.atts = '{"limit":3,"ajax_pagination":"next_prev","live_filter":"cur_post_same_categories","td_ajax_filter_type":"td_custom_related","class":"tdi_10_d03","td_column_number":3,"live_filter_cur_post_id":371,"live_filter_cur_post_author":"1","block_template_id":"","header_color":"","ajax_pagination_infinite_stop":"","offset":"","td_ajax_preloading":"","td_filter_default_txt":"","td_ajax_filter_ids":"","el_class":"","color_preset":"","border_top":"","css":"","tdc_css":"","tdc_css_class":"tdi_10_d03","tdc_css_class_style":"tdi_10_d03_rand_style"}';
block_tdi_10_d03.td_column_number = "3";
block_tdi_10_d03.block_type = "td_block_related_posts";
block_tdi_10_d03.post_count = "3";
block_tdi_10_d03.found_posts = "3";
block_tdi_10_d03.header_color = "";
block_tdi_10_d03.ajax_pagination_infinite_stop = "";
block_tdi_10_d03.max_num_pages = "1";
tdBlocksArray.push(block_tdi_10_d03);
</script><div id=tdi_10_d03 class="td_block_inner">
	...
	</div> <!-- ./td-related-span4 --></div><!--./row-fluid--></div><div class="td-next-prev-wrap"><a href="#" class="td-ajax-prev-page ajax-page-disabled" id="prev-page-tdi_10_d03" data-td_block_id="tdi_10_d03"><i class="td-icon-font td-icon-menu-left"></i></a><a href="#"  class="td-ajax-next-page ajax-page-disabled" id="next-page-tdi_10_d03" data-td_block_id="tdi_10_d03"><i class="td-icon-font td-icon-menu-right"></i></a></div></div> <!-- ./block -->
                                </div>
                        </div>
...
<p align="center" id="breadcrumbs"><span><span><a href="/">LIC Agent Hyderabad</a> >> <span><a href="/sub/child-plans">Child Plans</a> >> <strong class="breadcrumb_last" aria-current="page">LIC Jeevan Tarun Plan</strong></span></span></span></p><!-- Instagram -->
						...
						<ul class="mystickyelements-lists mystickyno-minimize">
										...
										<form id="stickyelements-form" action="" method="post" autocomplete="off">
												   ...
												   style="background-color: #7761DF;color:#FFFFFF;"/>
																						<input type="hidden" name="nonce" value="638a3803d837a1670002691638a3803d837e">
